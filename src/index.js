...
let basicInstructions = `Your mission is to ALLWAYS generate a full recepy in basic HTML format. Please always put a polite line as introduction, a line breake (</br>), the name of the recepy (center, undeline and bold and in the color: #6B8E23)), two breaks (</br></br>), the word 'Ingredients' (text align left and underline), a break line (</br>), the ingredients in bullets (after each bullet a break line </br>), two break lines (</br></br>), the word 'Instruction' (text align left and underline), a break line (</br>) and all the steps of the recepy in numbers (after each numbre a break line </br>). At the  end of the recepy,make 3 break lines and allways sign it as '- Generated by SheCodes AI' inside a <strong>`;

let context =
  "You have a partner and love to cook for both but your always forgot to go to the supermarket. Please follow the " +
  basicInstructions;
